...
def combine_all_foders():
    ...
    for file in all_files:
        ...
        big_df_training = big_df_training.append(this_df[7:length-7], ignore_index=True)

        # testing set is the last 7 days
        big_df_testing = big_df_testing.append(this_df[length-7:], ignore_index=True)
